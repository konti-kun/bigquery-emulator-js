/**
 * SAFE_SUBTRACT custom function for BigQuery emulator
 ...
 */
export function safeSubtract(...args: any[]): number | null {
  try {
    if (args.length !== 2) {
      console.log("SAFE_SUBTRACT: Expected 2 arguments");
      return null;
    }
    ...
    console.error("SAFE_SUBTRACT error:", error);
    return null;
  }
}
